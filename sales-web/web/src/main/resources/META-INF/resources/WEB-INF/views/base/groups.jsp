...
actionURL: "http://localhost:9099/api/groups",
httpMethod: method,
useSimpleHttp: true,
...
isc.RPCManager.sendRequest({
actionURL: "http://localhost:9099/api/groups/" + groupsId,
httpMethod: "DELETE",
useSimpleHttp: true,
contentType: "application/json; charset=utf-8",
httpHeaders: {"Authorization": "Bearer " + "${cookie['access_token'].getValue()}"},
...
fetchDataURL: "http://localhost:9099/api/groups/spec-list"
});
...
method = "POST";
isc.RPCManager.sendRequest({
actionURL: "http://localhost:9099/api/person",
httpMethod: method,
httpHeaders: {"Authorization": "Bearer " + "${cookie['access_token'].getValue()}"},
useSimpleHttp: true,
contentType: "application/json; charset=utf-8",
...
isc.RPCManager.sendRequest({
actionURL: "http://localhost:9099/api/person/" + personId,
httpMethod: "DELETE",
httpHeaders: {"Authorization": "Bearer " + "${cookie['access_token'].getValue()}"},
useSimpleHttp: true,
contentType: "application/json; charset=utf-8",
...
method = "POST";
isc.RPCManager.sendRequest({
actionURL: "http://localhost:9099/api/groupsPerson",
httpMethod: method,
httpHeaders: {"Authorization": "Bearer " + "${cookie['access_token'].getValue()}"},
contentType: "application/json; charset=utf-8",
showPrompt: false,
...
isc.RPCManager.sendRequest({
actionURL: "http://localhost:9099/api/groupsPerson/" + groupsPersonId,
httpMethod: "DELETE",
httpHeaders: {"Authorization": "Bearer " + "${cookie['access_token'].getValue()}"},
useSimpleHttp: true,
contentType: "application/json; charset=utf-8",
...
fetchDataURL: "http://localhost:9099/api/groupsPerson/spec-list"
});
