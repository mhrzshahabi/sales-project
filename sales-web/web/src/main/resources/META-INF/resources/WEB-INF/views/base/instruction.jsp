...
actionURL: "http://localhost:9099/api/instruction/" + InstructionId,
httpMethod: "DELETE",
...
// ######@@@@###&&@@###
fetchDataURL: "http://localhost:9099/api/instruction/spec-list"
});
...
isc.RPCManager.sendRequest(Object.assign(BaseRPCRequest, {
// ######@@@@###&&@@### pls correct callback
actionURL: "http://localhost:9099/api/instruction/",
