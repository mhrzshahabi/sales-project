...
validators : [{type: "isInteger", validateOnExit : true, stopOnError : true, errorMessage: "<spring:message
		code='global.form.correctType'/>"}]},
{name: "nameFA", title:"<spring:message code='currency.nameFa'/>", required: true, readonly:true ,width: 400 },
