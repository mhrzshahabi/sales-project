...
{name: "<%=names[i] + j %>",ID:"<%=names[i] + j %>",showTitle:false, type:'text',align:"center", width: 90 ,colSpan :1 ,defaultValue:"<%=result[i].toString() %>" },
<% } %>
...
<% for (int j = 0; j < list.size(); j++) {
	...
	for (int i = 14; i < 20; i++) { %>
<%if (i == 19) { %>
{name: "<%=names[i] + j %>",ID:"<%=names[i] + j %>",showTitle:false, type:'text',align:"center" ,colSpan :1, width: 72 ,defaultValue:"<%=result[i].toString() %>" },
<%} else { %>
{name: "<%=names[i] + j %>",ID:"<%=names[i] + j %>",showTitle:false, type:'text',align:"center", width: 72 ,colSpan :1 ,defaultValue:"<%=result[i].toString() %>" },
<% }
} %>
