...
fetchDataURL: "http://localhost:9099/api/country/spec-list"
});
...
actionURL: "http://localhost:9099/api/port/" + PortId,
httpMethod: "DELETE",
...
{name: "arrival" , title:"<spring:message code='port.arrival'/>" , width: "100%",colSpan :1 ,titleColSpan :1},
{name: "countryId" , title:"<spring:message
		code='country.nameFa'/>", type:'long' , width: "100%",editorType: "SelectItem",colSpan :1 ,titleColSpan :1
, optionDataSource:RestDataSource_CountryPort ,displayField:"nameFa"
...
isc.RPCManager.sendRequest({
// ######@@@@###### pls correct callback
actionURL: "http://localhost:9099/api/port/" ,
...
{name: "country.nameFa", title:"<spring:message code='country.nameFa'/>" , width: "50%",align:"center"}
],
sortField: 0,
dataPageSize: 50,
autoFetchData: true,
