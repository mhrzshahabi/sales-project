...
{name:"packingQuantity", title:"<spring:message code='dailyWarehouse.packingQuantity'/>",align:"center"},
],
dataFormat: "json",
jsonPrefix: "",
jsonSuffix: "",
...
, valueField:"id" ,pickListWidth:"400",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
,pickListFields:[
...
{name:"plant", title:"<spring:message code='dailyWarehouse.plant'/>",align:"center", width: 400, valueMap: {
"BandarAbbas": "<spring:message code='global.BandarAbbas'/>",
"Sarcheshmeh": "<spring:message code='global.Sarcheshmeh'/>",
"ShahreBabak": "<spring:message code='global.ShahreBabak'/>",
"Sungun": "<spring:message code='global.Sungun'/>"}},
{name:"operation", title:"<spring:message code='dailyWarehouse.operation'/>",align:"center", width: 400, valueMap: {
...
{name:"packingType", title:"<spring:message code='global.packingType'/>",align:"center", width: 400,valueMap: {
