...
actionURL: "http://localhost:9099/api/currencyRate/" + currencyRateId,
httpMethod: "DELETE",
...
{name:"id", hidden:true, },
{type:"RowSpacerItem"},
{name: "curDateDummy", title:"<spring:message code='currencyRate.curDate'/>", type:"date" ,width: "400" },
...
{name: "curDate", title:"<spring:message code='currencyRate.curDate'/>" , width: "50%" , align:"center"},
...
// ######@@@@###&&@@###
fetchDataURL: "http://localhost:9099/api/currencyRate/spec-list"
});
...
isc.RPCManager.sendRequest({
// ######@@@@###&&@@### pls correct callback
actionURL: "http://localhost:9099/api/currencyRate/" ,
