...
// ######@@@@###&&@@###
fetchDataURL: "http://localhost:9099/api/tozin/spec-list"
});
...
actionURL: "http://localhost:9099/api/tozin/" + TozinId,
httpMethod: "DELETE",
...
var ToolStripButton_Tozin_sum2 = isc.ToolStripButton.create({
...
var ToolStripButton_Tozin_sum1 = isc.ToolStripButton.create({
icon: "product/sum.png",
...
ToolStripButton_Tozin_sum1,
ToolStripButton_Tozin_sum2
]
});
...
isc.RPCManager.sendRequest(Object.assign(BaseRPCRequest, {
// ######@@@@###&&@@### pls correct callback
actionURL: "http://localhost:9099/api/tozin/",
