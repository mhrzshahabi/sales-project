...
fields:[
{name: "id", title: "id", primaryKey:true, canEdit:false, hidden: true},
{name: "fullname" , title:"<spring:message code='contact.name'/>", type:'text',align:"center", width: 180 },
{name: "contractNo" , title:"<spring:message code='contract.contractNo'/>", type:'text' , width: 180,align:"center"},
{name: "descl" , title:"<spring:message code='material.descl'/>", type:'text' ,align:"center", width: 180},
{name: "amount" , title:"<spring:message code='global.amount'/>", type:'float',align:"center", width: 180},
...
{name: "swb" , title:"<spring:message code='shipment.SWB'/>", type:'text', required: true, width: 180 ,align:"center"},
...
,valueMap:{"Load Ready":"<spring:message code='shipment.loadReady'/>","Resource":"<spring:message
		code='shipment.resource'/>"},align:"center"
},
...
[
{name:"id", title:"id", primaryKey:true, canEdit:false, hidden: true},
{name: "shipmentHeaderDateDummy" ,title:"<spring:message code='shipmentHeader.date'/>" , width: 480 , type:"date" },
{name:"description" ,title:"<spring:message
...
{name: "economicalCode", title: "<spring:message code='contact.economicalCode'/>", align: "center", width: 200},
...
{name: "bankSwift", title: "<spring:message code='contactAccount.bankSwift'/>", align: "center", width: 200},
...
sections:
[
{title:"<spring:message code='shipmentHeader.title'/>", items:VLayout_Body_Shipment_HeaderByRes ,expanded:true}
,{title:"<spring:message code='Shipment.title'/>", items:VLayout_Body_Shipment ,expanded:true}
,{title:"<spring:message code='shipment.shipmentResource'/>", items:VLayout_ShipmentResource_Body ,expanded:true}
],
