...
{name: "capacity", title:"<spring:message code='shipment.Price.capacity'/>", type:'long', hidden: true },
...
{name: "tblContactByCompany.nameEn", title:"<spring:message code='shipment.Price.shipingCompany'/>", type:'text' },
{name: "laycanStart", title:"<spring:message code='shipment.Price.laycanStart'/>", type:'long', hidden: true },
...
{name: "dispatch", title:"<spring:message code='shipment.Price.dispatch'/>", type:'text', width: "10%" },
{name: "freight", title:"<spring:message code='shipment.Price.freight'/>", type:'text', required: true, width: "10%" },
...
{name: "holds", title:"<spring:message code='shipment.Price.holds'/>", type:'text', required: true, width: "10%" },
],
dataFormat: "json",
jsonPrefix: "",
jsonSuffix: "",
...
{name: "tblPortByLoading.port", title:"<spring:message code='shipment.loading'/>", type:'text', width: "10%" },
{name: "tblPortByDischarge.port", title:"<spring:message
		code='shipment.discharge'/>", type:'text', required: true, width: "10%" },
{name: "tblPortByLoading.id", title:"<spring:message code='shipment.loading'/>", type:'text', width: "10%" },
...
{name: "amount", title:"<spring:message code='global.amount'/>", type:'float', width: "10%" , align: "center",},
...
{name: "status", title:"<spring:message code='shipment.staus'/>", type:'text', width: "10%" , align: "center"
, valueMap:{
...
[
{name:"id", title:"id", primaryKey:true, canEdit:false, hidden: true},
{name:"tblShipmentPrice.id" , title:"<spring:message code='tblShipmentPrice.name'/>",align:"center",hidden: true},
...
[
{name:"id", title:"id", primaryKey:true, canEdit:false, hidden: true},
{name: "tblShipmentPrice.id", title:"<spring:message
		code='shipment.Price'/>", type:'long' ,editorType: "SelectItem",colSpan:2
, optionDataSource:RestDataSource_Shipment_PriceByContract ,displayField:"tblContact.nameFA"
, valueField:"id" ,pickListWidth:"500",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
, pickListFields:
[
{name: "capacity", title:"<spring:message code='shipment.Price.capacity'/>" , type:'long' , align:"center"},
...
,icons: [{src: "pieces/pcal.png" ,click: function () { displayDatePicker('createDate', this ,'ymd', '/');}}]
...
{name: "tblContactByOwners.nameFA", title:"<spring:message code='shipmentContract.agant'/>" ,colSpan:2,canEdit:false},
{name: "tblContactByCharterer.id", title:"<spring:message
		code='shipmentContract.charterer'/>", type:'long' ,editorType: "SelectItem",colSpan:2
, optionDataSource:RestDataSource_ContactByShipmentContract ,displayField:"tblContact.nameFA"
, valueField:"id" ,pickListWidth:"500",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
, pickListFields:
[
{name: "nameFA", title: "<spring:message code='contact.nameFa'/>"},
...
{name: "tblContactByChainOfOwners.id", title:"<spring:message
		code='shipmentContract.owners'/>", type:'long' ,editorType: "SelectItem",colSpan:2
, optionDataSource:RestDataSource_ContactByShipmentContract ,displayField:"tblContact.nameFA"
, valueField:"id" ,pickListWidth:"500",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
, pickListFields:
[
...
{name:"capacity" , title:"<spring:message code='shipmentContract.capacity'/>",align:"center" ,colSpan:2},

{name:"laycanStart",ID:"laycanStart",title:"<spring:message
		code='shipmentContract.laycanStart'/>",align:"right" , width :"200"
,icons: [{src: "pieces/pcal.png" ,click: function () { displayDatePicker('laycanStart', this ,'ymd', '/');}}]
,blur : function()
{
...
,icons: [{src: "pieces/pcal.png" ,click: function () { displayDatePicker('laycanEnd', this ,'ymd', '/');}}]
,blur : function()
{
...
{name:"loadingRate" , title:"<spring:message code='shipmentContract.loadingRate'/>",align:"center" ,colSpan:2},
{name:"dischargeRate" , title:"<spring:message code='shipmentContract.dischargeRate'/>",align:"center" ,colSpan:2},
{name:"demurrage" , title:"<spring:message code='shipmentContract.demurrage'/>",align:"center" ,colSpan:2},
{name:"dispatch" , title:"<spring:message code='shipmentContract.dispatch'/>",align:"center" ,colSpan:2},
{name:"freight" , title:"<spring:message code='shipmentContract.freight'/>",align:"center" ,colSpan:2},
...
{name:"grossWeight" , title:"<spring:message code='shipmentContract.grossWeight'/>",align:"center" ,colSpan:2},
{name:"vesselName" , title:"<spring:message code='shipmentContract.vesselName'/>",align:"center" ,colSpan:2},
{name:"yearOfBuilt" , title:"<spring:message code='shipmentContract.yearOfBuilt'/>",align:"center" ,colSpan:2},
{name:"imoNo" , title:"<spring:message code='shipmentContract.imoNo'/>",align:"center" ,colSpan:2},
{name:"officialNo" , title:"<spring:message code='shipmentContract.officialNo'/>",align:"center" ,colSpan:2},
...
{name:"cranes" , title:"<spring:message code='shipmentContract.cranes'/>",align:"center" ,colSpan:2},
...
{name:"classType" , title:"<spring:message code='shipmentContract.classType'/>",align:"center" ,colSpan:2},
{name:"createDate",ID:"createDate",title:"<spring:message code='global.createDate'/>",align:"right" , width :"200"
,icons: [{src: "pieces/pcal.png" ,click: function () { displayDatePicker('createDate', this ,'ymd', '/');}}]
,defaultValue :"<%=dateUtil.todayDate()%>"
,blur : function()
{
...
{name:"weighingMethodes", title:"<spring:message code='shipmentContract.weighingMethodes'/>", type:'text',width :"200"
,colSpan:2
,valueMap:{
...
{name:"shipmentContractDate" , title:"<spring:message code='shipmentContract.shipmentContractDate'/>",align:"center"},
...
,{title:"<spring:message code='Shipment.title'/>" , items:VLayout_Body_ShipmentByContract ,expanded:true}
,{title:"<spring:message code='shipmentContract.title'/>" , items:VLayout_ShipmentContract_Body ,expanded:true}
],
