...
{name: "ETA", title:"<spring:message code='shipment.Price.ETA'/>", type:'text', required: true, width: "10%" },
],
dataFormat: "json",
jsonPrefix: "",
jsonSuffix: "",
...
fields:
[
{name:"id", title:"<spring:message code='contact.code'/>", primaryKey:true, canEdit:false, hidden: true},
{name:"tblShipment.id", title:"<spring:message code='contact.name'/>",align:"center",hidden: true},
{name:"tblShipment.tblContact.nameEN", title:"<spring:message code='contact.name'/>",align:"center" , width :"10%"},
{name:"tblShipment.shipmentType", title:"<spring:message code='shipment.inquiry.type'/>",align:"center" , width :"10%"
,valueMap:
{
...
{name: "tblMaterial.id", title:"<spring:message code='contact.name'/>", type:'long', hidden: true ,showHover:true},
...
{name: "shipmentType", title:"<spring:message
		code='shipment.shipmentType'/>", type:'text', width: "10%" ,valueMap:{"b":"bulk", "c":"container"},showHover:true},
...
{
var record = this.getSelectedRecord();
ListGrid_Shipment_Price.fetchData({"tblShipment.id":record.id},function (dsResponse, data, dsRequest) {ListGrid_Shipment_Price.setData(data);});
},
dataArrived : function (startRow, endRow) {
},
sortField: 0,
...
{name: "tblShipmentInquiry.id", title:"<spring:message
		code='shipment.inquiry.name'/>", type:'long' ,editorType: "SelectItem" ,colSpan :1 ,titleColSpan :1
, optionDataSource:RestDataSource_ShipmentInq ,displayField:"tblShipment.tblContact.nameEN"
, valueField:"id" ,pickListWidth:"450",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
,pickListFields:[{name:"tblShipment.tblContact.nameEN",width:150,align:"center"},{name:"id",width:150,align:"center"},{name:"tblShipment.shipmentType",width:150,align:"center"}] },

{name: "tblContactByCompany.id", title:"<spring:message
		code='shipment.Price.shipingCompany'/>", type:'long' ,editorType: "SelectItem",colSpan :1 ,titleColSpan :1
, optionDataSource:RestDataSource_Contact ,displayField:"nameEN",wrapTitle: false
, valueField:"id" ,pickListWidth:"450",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
...
{name: "demurrage", title:"<spring:message code='shipment.Price.demurrage'/>", type:'text',colSpan :1 ,titleColSpan :1},
{name: "dispatch", title:"<spring:message code='shipment.Price.dispatch'/>", type:'text' ,colSpan :1 ,titleColSpan :1},
{name: "freight", title:"<spring:message code='shipment.Price.freight'/>", type:'text',colSpan :1 ,titleColSpan :1},
{name: "vesselName", title:"<spring:message
...
{name: "imo", title:"<spring:message code='shipment.Price.imo'/>", type:'text' ,colSpan :1 ,titleColSpan :1},
{name: "holds", title:"<spring:message code='shipment.Price.holds'/>", type:'text',colSpan :1 ,titleColSpan :1},
{name: "cranesNO", title:"<spring:message code='shipment.Price.cranesNo'/>", type:'text',colSpan :1 ,titleColSpan :1},
{name: "ETA", title:"<spring:message code='shipment.Price.ETA'/>", type:'text',colSpan :1 ,titleColSpan :1},
]
});
...
{name: "tblContactByCompany.id", title:"<spring:message
		code='shipment.Price.shipingCompany'/>", type:'long' ,editorType: "SelectItem"
, optionDataSource:RestDataSource_Contact ,displayField:"nameEN",wrapTitle: false,colSpan :1 ,titleColSpan :1
, valueField:"id" ,pickListWidth:"450",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
,pickListFields:[{name:"nameFA",width:150,align:"center"},{name:"nameEN",width:150,align:"center"},{name:"code",width:150,align:"center"}] },
...
if (record==null || record.id==null)
return;
ListGrid_Shipment_Price.fetchData({"tblShipmentHeader.id":record.id},function (dsResponse, data, dsRequest) {ListGrid_Shipment_Price.setData(data);});
};
...
{name: "imo", title:"<spring:message code='shipment.Price.imo'/>", type:'text', width: "10%" , align: "center" },
{name: "vesselName", title:"<spring:message
...
sections:
[
{title:"<spring:message code='shipmentHeader.title'/>", items:VLayout_Body_Shipment_HeaderByPrice ,expanded:true}
,{title:"<spring:message code='Shipment.title'/>", items:VLayout_Body_ShipmentByPrice ,expanded:true}
,{title:"<spring:message code='evaluationResult.title'/>", items:VLayout_Body_Shipment_Price ,expanded:true}
],
