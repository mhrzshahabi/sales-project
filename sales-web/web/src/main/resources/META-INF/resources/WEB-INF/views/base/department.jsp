...
{name:"parentName",type:"staticText", title:"<spring:message code='department.name.head'/>",colSpan:3},
...
{name:"departmentNameLatin", type:"text", title: "<spring:message code='department.LatinName'/>",width:400,lenght:"255"},
]
});
...
buttons : [ isc.Button.create({ title:"<spring:message
		code='global.ok'/>" }), isc.Button.create({ title:"<spring:message code='global.cancel'/>" })],
