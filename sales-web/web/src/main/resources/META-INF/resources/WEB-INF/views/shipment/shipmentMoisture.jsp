...
{name: "tblInspectionByContact.id", title:"<spring:message code='shipment.Moisture.inspectionCompany'/>", type:'text' },
...
{name: "tblShipmentMoistureHeader.id", title: "id", canEdit:false, hidden:true,align:"center" },
...
ListGrid_ShipmentMoistureHeader.fetchData({"tblShipment.id":record.id},function (dsResponse, data, dsRequest) {ListGrid_ShipmentMoistureHeader.setData(data);});
},
...
{name: "tblInspectionByContact.id", title:"<spring:message code='shipment.Moisture.inspectionCompany'/>", type:'long'
...
updateDetails : function (viewer, record1, recordNum, field, fieldNum, value, rawValue) {
var record = this.getSelectedRecord();
ListGrid_ShipmentMoistureItem.fetchData({"tblShipmentMoistureHeader.id":record.id},function (dsResponse, data, dsRequest) {ListGrid_ShipmentMoistureItem.setData(data);});
},
dataArrived : function (startRow, endRow) {},
sortField: 0,
dataPageSize: 50,
