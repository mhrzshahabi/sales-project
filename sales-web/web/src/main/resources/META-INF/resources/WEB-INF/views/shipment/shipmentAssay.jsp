...
{name: "tblInspectionByContact.id", title:"<spring:message code='shipment.Assay.inspectionCompany'/>", type:'text' },
...
{name: "cu", title:"<spring:message code='shipment.Assay.cu'/>"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "ag", title:"<spring:message code='shipment.Assay.ag'/>"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "au", title:"<spring:message code='shipment.Assay.au'/>"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
],
dataFormat: "json",
jsonPrefix: "",
...
{name: "tblShipmentAssayHeader.id", title: "id", canEdit:false, hidden:true,align:"center" },
...
ListGrid_ShipmentAssayHeader.fetchData({"tblShipment.id":record.id},function (dsResponse, data, dsRequest) {ListGrid_ShipmentAssayHeader.setData(data);});
},
...
{name: "tblInspectionByContact.id", title:"<spring:message code='shipment.Assay.inspectionCompany'/>", type:'long'
,editorType: "SelectItem",colSpan :1 ,titleColSpan :1
, optionDataSource:RestDataSource_Contact ,displayField:"nameEN",wrapTitle: false,optionCriteria:{"inspector":"1"}
...
{name: "inspectionDate", title:"<spring:message code='shipment.Assay.inspectionDate'/>", type:'text',hidden:true },
{name: "inspectionDateDummy", title:"<spring:message code='shipment.Assay.inspectionDate'/>", type:'date' },
{name: "averageCuPercent", title:"<spring:message code='shipment.Assay.averageCuPercent'/>"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "averageAuPercent", title:"<spring:message code='shipment.Assay.averageAuPercent'/>"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "averageAgPercent", title:"<spring:message code='shipment.Assay.averageAgPercent'/>"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "totalDryWeight", title:"<spring:message code='shipment.Assay.totalDryWeight'/>"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "description", title:"<spring:message
...
{name: "averageCuPercent", title:"<spring:message code='shipment.Assay.averageCuPercent'/>",align:"center"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "averageAuPercent", title:"<spring:message code='shipment.Assay.averageAuPercent'/>",align:"center"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "averageAgPercent", title:"<spring:message code='shipment.Assay.averageAgPercent'/>",align:"center"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "totalDryWeight", title:"<spring:message code='shipment.Assay.totalDryWeight'/>",align:"center"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
],
recordClick : "this.updateDetails(viewer, record, recordNum, field, fieldNum, value, rawValue)",
updateDetails : function (viewer, record1, recordNum, field, fieldNum, value, rawValue) {
var record = this.getSelectedRecord();
ListGrid_ShipmentAssayItem.fetchData({"tblShipmentAssayHeader.id":record.id},function (dsResponse, data, dsRequest) {ListGrid_ShipmentAssayItem.setData(data);});
},
dataArrived : function (startRow, endRow) {},
sortField: 0,
dataPageSize: 50,
...
sections:
[
{title:"<spring:message code='Shipment.title'/>", items:VLayout_Body_ShipmentByAssayHeader ,expanded:true}
,{title:"<spring:message code='Shipment.title'/>", items:VLayout_Body_ShipmentAssayHeader ,expanded:true}
,{title:"<spring:message code='Shipment.title'/>", items:VLayout_Body_ShipmentAssayItem ,expanded:true}
],
