...
{name: "containerNo", title:"<spring:message code='shipment.Bol.containerNo'/>"
, type:'ineger', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
...
{name: "noPalete", title:"<spring:message code='shipment.Bol.noPalete'/>"
, type:'ineger', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "noBundle", title:"<spring:message code='shipment.Bol.noBundle'/>"
, type:'ineger', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "grossWeight", title:"<spring:message code='shipment.Bol.grossWeight'/>"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "netWeight", title:"<spring:message code='shipment.Bol.netWeight'/>"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
],
dataFormat: "json",
jsonPrefix: "",
...
{name: "id", title: "id", primaryKey:true, canEdit:false, hidden: true},
{name: "tblBolHeader.id", title: "id", canEdit:false, hidden:true},
{name: "containerType", title:"<spring:message code='shipment.Bol.containerType'/>", type:'text',align:"center" },
{name: "containerNo", title:"<spring:message code='shipment.Bol.containerNo'/>",align:"center"
, type:'ineger', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "sealNo", title:"<spring:message code='shipment.Bol.sealNo'/>", type:'text' ,align:"center"},
{name: "seal2No", title:"<spring:message code='shipment.Bol.seal2No'/>", type:'text' ,align:"center"},
{name: "noPalete", title:"<spring:message code='shipment.Bol.noPalete'/>",align:"center"
, type:'ineger', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "noBundle", title:"<spring:message code='shipment.Bol.noBundle'/>",align:"center"
, type:'ineger', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "grossWeight", title:"<spring:message code='shipment.Bol.grossWeight'/>",align:"center"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "netWeight", title:"<spring:message code='shipment.Bol.netWeight'/>",align:"center"
, type:'float', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
]
})
...
{name: "tblContractItemShipment.tblContractItem.tblContract.id", type:'long', hidden: true ,align:"center" },
{name: "tblContact.id", type:'long', hidden: true },
...
{name: "shipmentType", title:"<spring:message
		code='shipment.shipmentType'/>", type:'text', width: "10%" ,valueMap:{"b":"bulk", "c":"container"},showHover:true,align:"center" },
...
ListGrid_BolHeader.fetchData({"tblShipment.id":record.id},function (dsResponse, data, dsRequest) {ListGrid_BolHeader.setData(data);});
},
...
{name: "tblShipmentContract.id", title:"<spring:message code='shipment.Bol.shipmentContract'/>", type:'text' },
{name: "tblPortByDischarge.id", title:"<spring:message code='shipment.Bol.tblPortByDischarge'/>", type:'text' },
{name: "tblSwitchPort.id", title:"<spring:message code='shipment.Bol.tblSwitchPort'/>", type:'text'},
{name: "noContainer", title:"<spring:message code='shipment.Bol.noContainer'/>",
type:'integer', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "noBundle", title:"<spring:message code='shipment.Bol.noBundle'/>",
type:'integer', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "noPlate", title:"<spring:message code='shipment.Bol.noPlate'/>",
type:'integer', validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "blNo", title:"<spring:message code='shipment.Bol.blNo'/>", type:'text' },
{name: "swBlNo", title:"<spring:message code='shipment.Bol.swBlNo'/>", type:'text' },
{name: "grossWeight", title:"<spring:message code='shipment.Bol.grossWeight'/>",
...
{name: "bolDate", title:"<spring:message code='shipment.Bol.inspectionDate'/>", type:'text',hidden:true },
...
{name: "tblSwitchPort.id", title:"<spring:message code='port.port'/>", type:'text', canEdit:false , hidden: true },
{name: "tblSwitchPort.port", title:"<spring:message
		code='shipment.Bol.tblSwitchPort'/>", type:'text', canEdit:false,align:"center" },
{name: "noContainer", title:"<spring:message code='shipment.Bol.noContainer'/>", type:'text',align:"center" },
...
{name: "grossWeight", title:"<spring:message code='shipment.Bol.grossWeight'/>", type:'text',align:"center" },
{name: "netWeight", title:"<spring:message code='shipment.Bol.netWeight'/>", type:'text',align:"center" },
],
recordClick : "this.updateDetails(viewer, record, recordNum, field, fieldNum, value, rawValue)",
updateDetails : function (viewer, record1, recordNum, field, fieldNum, value, rawValue) {
var record = this.getSelectedRecord();
ListGrid_BolItem.fetchData({"tblBolHeader.id":record.id},function (dsResponse, data, dsRequest) {ListGrid_BolItem.setData(data);});
},
dataArrived : function (startRow, endRow) {},
sortField: 0,
dataPageSize: 50,
...
sections:
[
{title:"<spring:message code='Shipment.title'/>", items:VLayout_Body_ShipmentByBolHeader ,expanded:true}
