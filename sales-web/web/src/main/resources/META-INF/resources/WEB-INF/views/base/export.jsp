...
{name:"loadingLetterNo", title:"<spring:message code='export.loadingLetterNo'/>",align:"center", width: 400},
...
,icons: [{src: "pieces/pcal.png" ,click: function () { displayDatePicker('loadingLetterDate', this ,'ymd', '/');}}]
...
,pickListFields:[{name:"descl", title:"<spring:message code='material.descl'/>",width:200,align:"center"},
...
{name: "tblCountry.id", title:"<spring:message
		code='global.country'/>", type:'long' , width: 400,editorType: "SelectItem"
...
,icons: [{src: "pieces/pcal.png" ,click: function () { displayDatePicker('shipDate', this ,'ymd', '/');}}]
...
{name:"containerQuantity", title:"<spring:message code='export.containerQuantity'/>",align:"center"},
...
var ListGrid_Export = isc.ListGrid.create({
width: "100%",
height: "100%",
...
{name:"id", title:"id", primaryKey:true, canEdit:false, hidden: true},
{name:"loadingLetterNo", title:"<spring:message code='export.loadingLetterNo'/>",align:"center"},
{name:"loadingLetterDate", title:"<spring:message code='export.loadingLetterDate'/>",align:"center"},
{name: "tblMaterial.descl", title: "<spring:message code='goods.nameLatin'/> "},
{name:"containerQuantity", title:"<spring:message code='export.containerQuantity'/>",align:"center"},
{name:"cargo", title:"<spring:message code='export.cargo'/>",align:"center"},
