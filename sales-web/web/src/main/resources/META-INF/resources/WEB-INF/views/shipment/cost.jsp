...
fetchDataURL: "http://localhost:9099/api/contact/spec-list1"
});
...
fetchDataURL: "http://localhost:9099/api/contact/spec-list2"
});
...
fetchDataURL: "http://localhost:9099/api/contact/spec-list3"
});
...
fetchDataURL: "http://localhost:9099/api/cost/spec-list"
});
...
isc.RPCManager.sendRequest({
actionURL: "http://localhost:9099/api/cost/" + record.id,
httpMethod: "DELETE",
useSimpleHttp: true,
contentType: "application/json; charset=utf-8",
httpHeaders: {"Authorization": "Bearer " + "${cookie['access_token'].getValue()}"},
...
{type: "Header",defaultValue:"بازرسی - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -"},
{name: "sourceInspectorId", title:"<spring:message
		code='cost.sourceInspectorId'/>", type:'long' , width: "100%",editorType: "SelectItem", optionDataSource:RestDataSource_ContactBySourceInspector
,displayField:"nameFA", valueField:"id" ,pickListWidth:"500",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
,pickListFields:[{name:"nameFA",align:"center"},{name:"nameEN",align:"center"},{name : "country.nameFa" ,align: "center" } ] },
...
{name: "sourceInspectionCurrency", title:"<spring:message
		code='cost.sourceInspectionCurrency'/>", type:'text', width: "100%" ,valueMap:{"EURO":"EURO", "DOLLAR":"DOLLAR"}},
{name: "destinationInspectorId", title:"<spring:message
		code='cost.destinationInspectorId'/>", type:'long' , width: "100%",editorType: "SelectItem", optionDataSource:RestDataSource_ContactByDestinationInspector
,displayField:"nameFA", valueField:"id" ,pickListWidth:"500",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
,pickListFields:[{name:"nameFA",align:"center"},{name:"nameEN",align:"center"},{name : "country.nameFa" ,align: "center" } ] },
...
{name: "destinationInspectionCurrency", title:"<spring:message
		code='cost.destinationInspectionCurrency'/>", type:'text', width: "100%" ,valueMap:{"EURO":"EURO", "DOLLAR":"DOLLAR"}},
{name: "sarcheshmehLabCost", title:"<spring:message
		code='cost.sarcheshmehLabCost'/>", type:'integer', required: false, width: "100%" ,
validators : [{type: "isInteger", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "umpireCost", title:"<spring:message code='cost.umpireCost'/>", type:'float', required: false, width: "100%" ,
validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
...
validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "sourceGold", title:"<spring:message code='cost.sourceGold'/>", type:'float', required: false, width: "100%" ,
validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
...
validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{type: "Header",defaultValue:"بیمه - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -"},
{name: "insuranceId", title:"<spring:message
		code='cost.insuranceId'/>", type:'long' , width: "100%",editorType: "SelectItem", optionDataSource:RestDataSource_ContactByInsurance
,displayField:"nameFA", valueField:"id" ,pickListWidth:"500",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
,pickListFields:[{name:"nameFA",align:"center"},{name:"nameEN",align:"center"},{name : "country.nameFa" ,align: "center" } ] },
...
{name: "insuranceCostCurrency", title:"<spring:message
		code='cost.insuranceCostCurrency'/>", type:'text', width: "100%" ,valueMap:{"EURO":"EURO", "DOLLAR":"DOLLAR"}},
{name: "insuranceClause", title:"<spring:message
		code='cost.insuranceClause'/>", type:'text', width: "100%" ,valueMap:{"A":"A", "B":"B", "C":"C"}},
{type: "Header",defaultValue:"سایر - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -"},
{name: "otherCost", title:"<spring:message code='cost.otherCost'/>", type:'float', required: false, width: "100%" ,
validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
...
validators : [{type: "isInteger", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "postCost", title:"<spring:message code='cost.postCost'/>", type:'integer', required: false, width: "100%" ,
validators : [{type: "isInteger", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "thcCost", title:"<spring:message code='cost.thcCost'/>", type:'float', required: false, width: "100%" ,
validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "blFeeCost", title:"<spring:message code='cost.blFeeCost'/>", type:'float', required: false, width: "100%" ,
validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "demandCost", title:"<spring:message code='cost.demandCost'/>", type:'float', required: false, width: "100%" ,
validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "contractorCost", title:"<spring:message
		code='cost.contractorCost'/>", type:'float', required: false, width: "100%" ,
validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "counterCost", title:"<spring:message code='cost.counterCost'/>", type:'float', required: false, width: "100%" ,
validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "disinfectionCost", title:"<spring:message
		code='cost.disinfectionCost'/>", type:'float', required: false, width: "100%" ,
validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
{name: "portCost", title:"<spring:message code='cost.portCost'/>", type:'float', required: false, width: "100%" ,
validators : [{type: "isFloat", validateOnExit : true, stopOnError : true, errorMessage: "لطفا مقدار عددی وارد نمائید."}]},
]
});
...
method="POST";
isc.RPCManager.sendRequest({
actionURL: "http://localhost:9099/api/cost/" ,
httpMethod: method,
useSimpleHttp: true,
contentType: "application/json; charset=utf-8",
httpHeaders: {"Authorization": "Bearer " + "${cookie['access_token'].getValue()}"},
...
{name: "sourceInspectionCost", title:"<spring:message
		code='cost.sourceInspectionCost'/>", type:'float', required: true, width: "60" , align: "center",showHover:true},
{name: "sourceInspectionCurrency", title:"<spring:message
...
{name: "destinationInspectionCost", title:"<spring:message
		code='cost.destinationInspectionCost'/>", type:'float', required: true, width: "60" , align: "center",showHover:true},
{name: "destinationInspectionCurrency", title:"<spring:message
...
{name: "sarcheshmehLabCost", title:"<spring:message
		code='cost.sarcheshmehLabCost'/>", type:'integer', required: true, width: "60" , align: "center",showHover:true},
...
{name: "destinationMolybdenum", title:"<spring:message
		code='cost.destinationMolybdenum'/>", type:'float', required: true, width: "60" , align: "center",showHover:true},
