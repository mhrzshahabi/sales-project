...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>
	...
	var RestDataSource_Shipment_CostHeader = isc.RestDataSource.create({
		fields: [
...
// {name: "dischargeAddress", title:"<spring:message
	...
	var VLayout_Body_Shipment_CostHeader = isc.VLayout.create({
		...
		height: "100%",
		members: [
			HLayout_Grid_Shipment_CostHeader
		]
	});
	//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
// ######@@@@###&&@@###
	...
	var DynamicForm_Cost = isc.DynamicForm.create({
		...
		code='cost.umpireCostCurrency'/>", type: 'text', width: "100%",defaultValue: "DOLLAR", valueMap: dollar
				},
				{
					type: "Header",
					defaultValue: "محتوی - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -"
		...
		code='cost.otherCostCurrency'/>", type: 'text', width: "100%",defaultValue: "DOLLAR", valueMap: dollar
				},
				{
...
// },{operationId:"00"});
	...
	isc.SectionStack.create({
		...
		sections:
			[
				{title: "<spring:message code='Shipment.title'/>", items: VLayout_Body_Shipment_CostHeader, expanded: true}
