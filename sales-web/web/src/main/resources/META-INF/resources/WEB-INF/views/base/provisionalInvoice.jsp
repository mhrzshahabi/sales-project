...
{name: "tblShipmentContract.id", title:"<spring:message code='shipment.Bol.shipmentContract'/>", type:'text' },
{name: "tblPortByDischarge.id", title:"<spring:message code='port.port'/>", type:'text', canEdit:false },
...
{name: "tblSwitchPort.port", title:"<spring:message code='shipment.Bol.tblSwitchPort'/>", type:'text', canEdit:false },
...
{name: "inspectionCostPercentSource", title:"<spring:message code='contract.inspectionCostPercentSource'/>"},
{name: "inspectionCostPercentDest", title:"<spring:message code='contract.inspectionCostPercentDest'/>"},
...
[
{name:"id", hidden:true },
{name: "tblContract.id", title:"<spring:message
		code='contract.title'/>", type:'long', width: "100%",editorType: "SelectItem"
, optionDataSource:RestDataSource_Contract ,displayField:"contractNo",colSpan :1 ,wrapTitle: false,titleColSpan :1
, valueField:"id" ,pickListWidth:"500",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
, pickListFields:
[
{name:"contractNo", title:"<spring:message code='contract.contractNo'/>",width:150,align:"center"},
{name:"contractDate", title:"<spring:message code='contract.contractDate'/>",width:150,align:"center"},
{name:"tblContact.nameFA", title:"<spring:message code='contact.name'/>",width:200,align:"center"}
]
},
{name: "tblMaterial.id", title:"<spring:message
		code='goods.nameFa'/>", type:'long' , width: "100%",editorType: "SelectItem"
, optionDataSource:RestDataSource_Material ,displayField:"descl",autoFetchData:false,colSpan :1 ,wrapTitle: false,titleColSpan :1
, valueField:"id" ,pickListWidth:"500",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
,pickListFields:
[
{name:"descl", title:"<spring:message code='material.descl'/>",width:200,align:"center"},
...
{name: "tblShipment.id", title:"<spring:message
		code='Shipment.title'/>", type:'long' , width: "100%",editorType: "SelectItem"
, optionDataSource:RestDataSource_Shipment ,displayField:"amount",autoFetchData:false,colSpan :1 ,wrapTitle: false,titleColSpan :1
, valueField:"id" ,pickListWidth:"500",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
,pickListFields:
[
{name:"tblContact.nameFA", title:"<spring:message code='contact.name'/>",width:200,align:"center"},
{name:"shipmentType", title:"<spring:message code='shipment.shipmentType'/>",width:100,align:"center"},
{name:"dischargeAddress", title:"<spring:message code='shipment.discharge'/>",width:100,align:"center"},
{name:"amount", title:"<spring:message code='global.amount'/>",width:100,align:"center"}
]
,getPickListFilterCriteria : function ()
{
...
{name: "tblBolHeader.id", title:"<spring:message
		code='bol.title'/>", type:'long' , width: "100%",editorType: "SelectItem"
, optionDataSource:RestDataSource_BolHeader ,displayField:"blNo",autoFetchData:false,colSpan :1 ,wrapTitle: false,titleColSpan :1
, valueField:"id" ,pickListWidth:"500",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
,pickListFields:
[
{name:"blNo", title:"<spring:message code='shipment.Bol.blNo'/>",width:200,align:"center"},
{name:"swBlNo", title:"<spring:message code='shipment.Bol.swBlNo'/>",width:200,align:"center"},
{name:"bolDate", title:"<spring:message code='shipment.Bol.bolDate'/>",width:100,align:"center"}
]
,getPickListFilterCriteria : function ()
{
...
,icons: [{src: "pieces/pcal.png" ,click: function () { displayDatePicker('refDate', this ,'ymd', '/');}}]
...
{name: "LMEcopper", title:"<spring:message
		code='provisionalInvoice.LMEcopper'/>" , width: "100%",colSpan :1 ,wrapTitle: false,titleColSpan :1, required: true},
{name: "LMEsilver", title:"<spring:message
		code='provisionalInvoice.LMEsilver'/>", width: "100%",colSpan :1 ,wrapTitle: false,titleColSpan :1, required: true},
{name: "LMEgold", title:"<spring:message
		code='provisionalInvoice.LMEgold'/>" , width: "100%",colSpan :1 ,wrapTitle: false,titleColSpan :1, required: true},
{name: "totalNetWet", title:"<spring:message
		code='provisionalInvoice.totalNetWet'/>" , width: "100%",colSpan :1 ,wrapTitle: false,titleColSpan :1, required: true
},
{name: "totalNetDry", title:"<spring:message
		code='provisionalInvoice.totalNetDry'/>" , width: "100%",colSpan :1 ,wrapTitle: false,titleColSpan :1, required: true},
{name: "totalMoisture", title:"<spring:message
		code='provisionalInvoice.totalMoisture'/>" , width: "100%",colSpan :1 ,wrapTitle: false,titleColSpan :1, required: true},
]
});
