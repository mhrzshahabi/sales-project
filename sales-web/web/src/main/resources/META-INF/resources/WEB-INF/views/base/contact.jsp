...
fetchDataURL: "http://localhost:9099/api/contactAccount/spec-list"
});
...
fetchDataURL: "http://localhost:9099/api/bank/spec-list"
});
...
actionURL: "http://localhost:9099/api/contact",
...
isc.RPCManager.sendRequest(Object.assign(BaseRPCRequest, {
actionURL: "http://localhost:9099/api/contact/" + contactId,
httpMethod: "DELETE",
callback: function (RpcResponse_o) {
if (RpcResponse_o.httpResponseCode == 200 || RpcResponse_o.httpResponseCode == 201) {
ListGrid_Contact.invalidateCache();
...
isc.RPCManager.sendRequest(Object.assign(BaseRPCRequest, {
actionURL: "http://localhost:9099/api/contactAccount",
httpMethod: "POST",
...
isc.RPCManager.sendRequest(Object.assign(BaseRPCRequest, {
actionURL: "http://localhost:9099/api/contactAccount/" + contactAccountId,
httpMethod: "DELETE",
callback: function (RpcResponse_o) {
if (RpcResponse_o.httpResponseCode == 200 || RpcResponse_o.httpResponseCode == 201) {
ListGrid_ContactAccount.invalidateCache();
