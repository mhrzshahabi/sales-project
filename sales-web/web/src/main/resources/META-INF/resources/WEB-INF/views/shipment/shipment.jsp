...
var RestDataSource_Person_EmailCC = isc.RestDataSource.create({
fields: [
{name: "id", title: "id", primaryKey:true, canEdit:false, hidden: true},
{name: "contactId"},
{name: "contact.nameFA"},
...
fetchDataURL: "http://localhost:9099/api/person/spec-list"
});
...
fetchDataURL: "http://localhost:9099/api/contractPerson/spec-list"
});
...
{name:"shipment.tblContact.nameEN", title:"<spring:message code='contact.name'/>",align:"center" , width :"10%"},
...
fetchDataURL: "http://localhost:9099/api/shipmentEmail/spec-list"
});
...
isc.RPCManager.sendRequest({
// ######@@@@###&&@@### pls correct callback
actionURL: "http://localhost:9099/api/shipmentEmail/" ,
httpMethod: methodXXXX,
httpHeaders: {"Authorization": "Bearer " + "${cookie['access_token'].getValue()}"},
// httpMethod: "POST",
useSimpleHttp: true,
...
fields:[
{name:"id", title:"id", primaryKey:true, canEdit:false, hidden: true},
{name: "contact.nameFA", title:"<spring:message code='contact.name'/>", type:'long' , width: 120,align:"center"},
...
RestDataSource_ContractPerson.fetchData({contractId:contractId},function (dsResponse, data, dsRequest) { DynamicForm_ShipmentEmail.setValue("emailCC",data[0].emailCC); });
RestDataSource_Contact.fetchData({"id":record.tblContactId},function (dsResponse, data, dsRequest) { DynamicForm_ShipmentEmail.setValue("emailTo",data[0].email);});
