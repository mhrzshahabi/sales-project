...
var ListGrid_ShipmentByInspectionContract = isc.ListGrid.create({
width: "100%",
height: "100%",
...
ListGrid_InspectionContract.fetchData({"tblShipment.id":record.id},function (dsResponse, data, dsRequest) {ListGrid_InspectionContract.setData(data);});
...
{name: "sampling",title: "<spring:message code='inspectionContract.sampling'/>",type: 'checkbox',width: 50},
...
{name: "tblShipmentContract.id", title:"<spring:message
		code='shipmentContract.title'/>", type:'long' , width: 700,editorType: "SelectItem"
, optionDataSource:RestDataSource_ShipmentContractByInsContract ,displayField:"tblContactByOwners.nameFA"
...
{name: "tblContactByInspection.id", title:"<spring:message
		code='contract.title'/>", type:'long' , width: 700,editorType: "SelectItem"
, optionDataSource:RestDataSource_ContactByInspection ,displayField:"nameFA"
...
{name: "nameFA", title: "<spring:message code='contact.nameFa'/>", align: "center", width: 280},
