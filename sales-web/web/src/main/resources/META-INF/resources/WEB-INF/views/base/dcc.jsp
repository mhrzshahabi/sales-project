...
actionURL: "http://localhost:9099/api/dcc/" + dccId,
httpMethod: "DELETE",
...
{name: "createUser", title: "<spring:message code='global.creator'/>", type: 'text', width: 400}

],
fetchDataURL: "http://localhost:9099/api/dcc/spec-list"
});
...
request.open("POST", "http://localhost:9099/api/dcc/add/");
