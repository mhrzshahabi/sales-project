...
fetchDataURL: "http://localhost:9099/api/contract/spec-list"
});
...
fetchDataURL: "http://localhost:9099/api/incoterms/spec-list"
});
...
fetchDataURL: "http://localhost:9099/api/material/spec-list"
});
...
fetchDataURL: "http://localhost:9099/api/unit/spec-list"
});
...
actionURL: "http://localhost:9099/api/contract/" + record.id,
httpMethod: "DELETE",
...
actionURL: "http://localhost:9099/api/contract/",
httpMethod: method,
useSimpleHttp: true,
...
fetchDataURL: "http://localhost:9099/api/contractShipment/spec-list"
});
...
actionURL: "http://localhost:9099/api/contractShipment/" + ContractShipmentId,
httpMethod: "DELETE",
httpHeaders: {"Authorization": "Bearer " + "${cookie['access_token'].getValue()}"},
// httpMethod: "POST",
useSimpleHttp: true,
...
isc.RPCManager.sendRequest({
// ######@@@@###&&@@### pls correct callback
actionURL: "http://localhost:9099/api/contractShipment/",
