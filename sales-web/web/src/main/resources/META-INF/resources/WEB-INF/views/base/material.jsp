...
// ######@@@@###&&@@###
fetchDataURL: "http://localhost:9099/api/feature/spec-list"
});
...
// ######@@@@###&&@@###
fetchDataURL: "http://localhost:9099/api/materialFeature/spec-list"
});
...
actionURL: "http://localhost:9099/api/material/",
...
isc.RPCManager.sendRequest(Object.assign(BaseRPCRequest, {
// ######@@@@###&&@@### pls correct callback
actionURL: "http://localhost:9099/api/material/" + materialId,
httpMethod: "DELETE",
callback: function (RpcResponse_o) {
// ######@@@@###&&@@###
if (RpcResponse_o.httpResponseCode == 200 || RpcResponse_o.httpResponseCode == 201) {
...
isc.RPCManager.sendRequest(Object.assign(BaseRPCRequest, {
// ######@@@@###&&@@### pls correct callback
actionURL: "http://localhost:9099/api/materialFeature/" + MaterialFeatureId,
httpMethod: "DELETE",
callback: function (RpcResponse_o) {
// ######@@@@###&&@@###
if (RpcResponse_o.httpResponseCode == 200 || RpcResponse_o.httpResponseCode == 201) {
...
isc.RPCManager.sendRequest(Object.assign(BaseRPCRequest, {
// ######@@@@###&&@@### pls correct callback
actionURL: "http://localhost:9099/api/materialFeature/",
httpMethod: methodXXXX,
data: JSON.stringify(data),
callback: function (RpcResponse_o) {
// ######@@@@###&&@@###
