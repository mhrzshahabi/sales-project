...
{name: "title", title:"<spring:message code='person.title'/>", type:'text', width: 400,valueMap:{"MR":"<spring:message
...
[
{name:"id", title:"id", primaryKey:true, canEdit:false, hidden: true},
{name:"tblShipmentHeader.id", title:"<spring:message code='contact.name'/>",align:"center",hidden: true},
...
[
{name:"id", title:"id", primaryKey:true, canEdit:false, hidden: true},
{name:"tblShipmentHeader.id", title:"<spring:message code='shipment.name'/>",align:"center",hidden: true},
{name:"tblContact.nameFA", title:"<spring:message code='contact.name'/>",align:"center" , width :"10%"},
{name:"description",title:"<spring:message code='shipment.description'/>",align:"center" , width :"10%"}
],
dataFormat: "json",
jsonPrefix: "",
jsonSuffix: "",
...
fields:[
{name:"id", title:"id", primaryKey:true, canEdit:false, hidden: true},
{name: "tblContact.nameFA", title:"<spring:message code='contact.name'/>", type:'long' , width: 120,align:"center"},
{name: "fullName", title:"<spring:message code='person.fullName'/>", type:'text', required: true, width: 150 },
{name: "title", title:"<spring:message code='person.title'/>", type:'text', width: 150,valueMap:{"MR":"<spring:message
		code='global.MR'/>","MIS":"<spring:message code='global.MIS'/>","MRS":"<spring:message code='global.MRS'/>",} },
...
,icons: [{src: "pieces/pcal.png" ,click: function () { displayDatePicker('closeDate', this ,'ymd', '/');}}]
...
{name:"emailType",title:"<spring:message code='shipment.emailType'/>",align:"center" , width :"700"},
{name:"emailSubject",title:"<spring:message code='global.emailSubject'/>",align:"center" , width :"700"},
{name: "tblShipmentResource.id", title:"<spring:message
		code='shipment.shipmentResource'/>", type:'long' , width: 700,editorType: "SelectItem"
, optionDataSource:RestDataSource_ShipmentResourceByInquiry ,displayField:"tblContact.nameFA"
, valueField:"id" ,pickListWidth:"680",pickListheight:"500" ,pickListProperties: {showFilterEditor:true}
, pickListFields:
[
{name:"id", title:"id", primaryKey:true, canEdit:false, hidden: true},
{name:"tblContact.nameFA", title:"<spring:message code='contact.name'/>",align:"center" , width :"50%"},
{name:"description",title:"<spring:message code='shipment.description'/>",align:"center" , width :"50%" }
]
,change: function(){
...
{name:"emailRespond",title:"<spring:message code='global.emailRespond'/>",align:"center" , width :"700"},
...
sections:
[
{title:"<spring:message code='shipmentHeader.title'/>", items:VLayout_Body_Shipment_HeaderByTender ,expanded:true}
,{title:"<spring:message code='Shipment.title'/>", items:VLayout_Body_ShipmentBytender ,expanded:true}
,{title:"<spring:message code='tenderNotice.title'/>", items:VLayout_ShipmentInquiry_Body ,expanded:true}
],
