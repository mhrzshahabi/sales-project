...
actionURL: "http://localhost:9099/api/glossary/" + glossaryId,
httpMethod: "DELETE",
...
// ######@@@@###&&@@###
fetchDataURL: "http://localhost:9099/api/glossary/spec-list"
});
...
isc.RPCManager.sendRequest(Object.assign(BaseRPCRequest, {
// ######@@@@###&&@@### pls correct callback
actionURL: "http://localhost:9099/api/glossary/",
