...
//				ResponseEntity<String> processDiagram = restTemplate.exchange("http://localhost:9090/api/workflow/userTask/count/" + session.getAttribute("username"), HttpMethod.GET, request, String.class);
