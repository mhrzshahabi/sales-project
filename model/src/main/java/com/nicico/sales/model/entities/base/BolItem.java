...
public class BolItem extends Auditable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "BOL_ITEM_SEQ")
    @SequenceGenerator(name = "BOL_ITEM_SEQ", sequenceName = "SEQ_BOL_ITEM_ID",allocationSize = 1)
