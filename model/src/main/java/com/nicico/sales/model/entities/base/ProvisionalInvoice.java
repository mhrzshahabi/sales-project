...
public class ProvisionalInvoice extends Auditable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PROVISIONAL_INVOICE_SEQ")
    @SequenceGenerator(name = "PROVISIONAL_INVOICE_SEQ", sequenceName = "SEQ_PROVISIONAL_INVOICE_ID",allocationSize = 1)
