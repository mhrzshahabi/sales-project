...
public class ContactAccount extends Auditable {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CONTACT_ACCOUNT_SEQ")
    @SequenceGenerator(name = "CONTACT_ACCOUNT_SEQ", sequenceName = "SEQ_CONTACT_ACCOUNT_ID",allocationSize = 1)
