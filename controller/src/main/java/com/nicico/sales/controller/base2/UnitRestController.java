package com.nicico.sales.controller.base2;
...
public class UnitRestController {
    ...
    public ResponseEntity<Void> delete(@Validated @RequestBody UnitDTO.Delete request) {
        ...
        unitService.deleteAll(request);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @Loggable
    @GetMapping(value = "/spec-list")
    public ResponseEntity<TotalResponse<UnitDTO.Info>> list(@RequestParam MultiValueMap<String, String> criteria) {
