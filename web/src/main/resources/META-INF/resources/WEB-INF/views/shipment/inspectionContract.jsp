...
var ListGrid_PersonByInspectionContract_EmailCC = isc.ListGrid.create({
          ...
          dataSource: RestDataSource_PersonByInspectionContract_EmailCC,
           fields:[
               ...
               {name: "title", title:"<spring:message code='person.title'/>", type:'text', width: 150,valueMap:{"MR":"<spring:message code='global.MR'/>","MIS":"<spring:message code='global.MIS'/>","MRS":"<spring:message code='global.MRS'/>",} },
...
var DynamicForm_InspectionContract = isc.DynamicForm.create({
    ...
    [
        ...
        {name: "superviseWeighing",title: "<spring:message code='inspectionContract.superviseWeighing'/>",type: 'checkbox',width: 50 },
        {name: "sampling",title: "<spring:message code='inspectionContract.sampling'/>",type: 'checkbox',width: 50},
        {name: "moistureDetermination",title: "<spring:message code='inspectionContract.moistureDetermination'/>",type: 'checkbox',width: 50},
...
/*Comment By JZ*/
        ...
        {name:"emailBody",title:"<spring:message code='global.emailBody'/>",align:"center" ,textAlign:"left",  width :"700",type:"textArea",height:200},
