...
function invoiceExport() {
                            ...
                            [isc.ToolStrip.create({
                                ...
                                members:
                                    [
                                        ...
                                        isc.ToolStripButtonRemove.create({
                                            ...ieTab.Layouts.ToolStripButtons.remove,
                                        ...
                                        isc.ToolStrip.create({
                                            ...
                                            members: [
                                                isc.ToolStripButtonRefresh.create({
                                                    ...ieTab.Layouts.ToolStripButtons.refresh,
    ...
    /**********************************************METHOD******************************************************************/
    /**********************************************FIELD*******************************************************************/
    ieTab.Fields.ContractItem = function () {
        return {
            ...
            optionDataSource: isc.MyRestDataSource.create({
                ...ieTab.RestDataSources.shipments()
