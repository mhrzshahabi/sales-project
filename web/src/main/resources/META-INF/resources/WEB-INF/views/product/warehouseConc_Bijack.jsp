...
//<script>
    ...
    var DynamicForm_warehouseConc_Bij = isc.DynamicForm.create({
        titleWidth: "150",
        itemKeyPress (item, keyName, characterValue){
               if(keyName=="Enter" && DynamicForm_warehouseConc_Bij.getValue("destinationTozinPlantStaticId") !== undefined){
                    var RestDataSource_TozinStatic_BandarAbbas_optionCriteria = {
                            ...
                            criteria: [{
                                ...
                                fieldName: "tozinId",
                                operator: "equals",
                                value: DynamicForm_warehouseConc_Bij.getValue("destinationTozinPlantStaticId")
                            }]
                        };
                    RestDataSource_tozin_IN_WAREHOUSECAD_ONWAYPRODUCT.fetchData(RestDataSource_TozinStatic_BandarAbbas_optionCriteria,function(dsResponse, data, dsRequest) {
                            if (data.length==0){
                                ...
                                DynamicForm_warehouseConc_Bij.clearValue("destinationTozinPlantStaticId")
                                DynamicForm_warehouseConc_Bij.getField('destinationTozinPlantId').setDisabled(false);
                            }else{
                                DynamicForm_warehouseConc_Bij.setValue("destinationTozinPlantId",DynamicForm_warehouseConc_Bij.getValue("destinationTozinPlantStaticId"));
                                DynamicForm_warehouseConc_Bij.setValue("destinationUnloadDate", data[0].tozinDate);
        ...
        fields: [{
            ...
            changed(form, item, value) {
                if(value==undefined){
                    ...
                    DynamicForm_warehouseConc_Bij.getField('destinationTozinPlantId').setDisabled(true);
                }
            }
            },{
                align: "center",
            ...
            changed(form, item, value) {
                DynamicForm_warehouseConc_Bij.setValue("destinationUnloadDate", item.getSelectedRecord().tozinDate);
            }
            },{
            ...
            },
{
    ...
    var IButton_warehouseCAD_Save = isc.IButtonSave.create({
        ...
        click: function () {
            if (DynamicForm_warehouseConc_Bij.getValue("destinationTozinPlantId") == undefined && DynamicForm_warehouseConc_Bij.getValue("destinationTozinPlantStaticId") == undefined) {
                isc.warn("<spring:message code='warehouseCad.tozinBandarAbbasErrors'/>");
                DynamicForm_warehouseConc_Bij.validate()
                return;
            }
            DynamicForm_warehouseConc_Bij.validate();
            if (DynamicForm_warehouseConc_Bij.hasErrors())
                return;

            DynamicForm_warehouseConc_Bij.setValue("materialItemId", ListGrid_warehouseCAD.getSelectedRecord().materialItemId);
            var data_WarehouseCad = DynamicForm_warehouseConc_Bij.getValues();
                if(DynamicForm_warehouseConc_Bij.getValue("destinationTozinPlantId") != undefined)
                        data_WarehouseCad.destinationTozinPlantId = DynamicForm_warehouseConc_Bij.getValue("destinationTozinPlantId")
                else if(DynamicForm_warehouseConc_Bij.getValue("destinationTozinPlantStaticId")!= undefined){
                        data_WarehouseCad.destinationTozinPlantId = DynamicForm_warehouseConc_Bij.getValue("destinationTozinPlantStaticId")
                }
    ...
    DynamicForm_warehouseConc_Bij.clearValues();
    DynamicForm_warehouseConc_Bij.editRecord(ListGrid_warehouseCAD.getSelectedRecord());

    DynamicForm_warehouseConc_Bij.setValue("materialItemId", ListGrid_warehouseCAD.getSelectedRecord().materialItem.gdsName);
    DynamicForm_warehouseConc_Bij.setValue("plant", ListGrid_warehouseCAD.getSelectedRecord().plant);
    DynamicForm_warehouseConc_Bij.setValue("warehouseNo", "BandarAbbas");
    DynamicForm_warehouseConc_Bij.setValue("movementType", ListGrid_warehouseCAD.getSelectedRecord().movementType);
    DynamicForm_warehouseConc_Bij.setValue("sourceTozinPlantId", ListGrid_warehouseCAD.getSelectedRecord().sourceTozinPlantId);
    DynamicForm_warehouseConc_Bij.setValue("destinationTozinPlantStaticId", ListGrid_warehouseCAD.getSelectedRecord().destinationTozinPlantId);
    DynamicForm_warehouseConc_Bij.setValue("sourceLoadDate", ListGrid_warehouseCAD.getSelectedRecord().sourceLoadDate);
    DynamicForm_warehouseConc_Bij.setValue("containerNo", ListGrid_warehouseCAD.getSelectedRecord().containerNo);
