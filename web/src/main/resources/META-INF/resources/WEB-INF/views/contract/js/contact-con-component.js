...
////********************************************************************************************
isc.defineClass("ContactConComponent", isc.VStack).addProperties({
    width: "100%",
    height: "100%",
    ...
    initWidget: function () {
        ...
        this.addMember(isc.HLayout.create({height: "30", members: [dynamicForm_ContactConcCustomer]}), 0);

////////////////////////////
        let Contact_ContactConcBuyer = isc.DynamicForm.create({
        ...
        this.addMember(isc.HLayout.create({
            width: "100%",
            members: [Contact_ContactConcBuyer, Contact_ContactCadAgentBuyer]
        }), 1);
/////////////
        ...
        this.addMember(isc.HLayout.create({height: "30", align: "top", members: [DynamicForm_ContactConcSeller]}), 2);
        ...
        this.addMember(isc.HLayout.create({
            width: "100%",
            members: [Contact_ContactCadSeller, Contact_ContactAgentSellerConc]
        }), 3);
    }
});
