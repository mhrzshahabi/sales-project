...
var RestDataSource_DailyWarehouse = isc.MyRestDataSource.create({
    ...
    var Menu_ListGrid_DailyWarehouse = isc.Menu.create({
  	...
  	fields: [
  		...
  		},
  		{
  			...
  			title: "<spring:message code = 'global.amount'/>",
  		    align:"center",
            type: 'float', required: true, width: 400,
  			validators: [{
  				type: "isFloat",
  				validateOnExit: true,
  				stopOnError: true,
  		...
  		{
  			  name: "packingQuantity",
  			   title: "<spring:message code ='global.packingQuantity'/>,
  			   align: "center",
  			   type: 'long', required: true, width: 400,
  			    validators: [{
  				type: "isInteger",
  				validateOnExit: true,
  				stopOnError: true,
    ...
    var ListGrid_DailyWarehouse = isc.ListGrid.create({
    	...
    	updateDetails: function(viewer, record1, recordNum, field, fieldNum, value, rawValue) {
    		...
    		ListGrid_DailyWarehouseFeature.fetchData({
    			"tblDailyWarehouse.id": record.id
