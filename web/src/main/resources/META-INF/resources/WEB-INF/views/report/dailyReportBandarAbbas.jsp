...
//<script>
    ...
    var RestDataSource_DailyReport = isc.MyRestDataSource.create({
    	fields: [{
    		...
    		{
    			name: "amountDay",
    			title: "<spring:message code='dailyReport.amountDay'/>"
    		},
    		{
    			name: "amountImportDay",
    			title: "<spring:message code='dailyReport.amountImportDay'/>"
    		},
    		{
    			name: "amountFirstDay",
    			title: "<spring:message code='dailyReport.amountFirstDay'/>"
    		},
    		{
    			name: "amountExportDay",
    			title: "<spring:message code='dailyReport.amountExportDay'/>"
    		},
    		{
    			name: "amountReviseDay",
    			title: "<spring:message code='dailyReport.amountReviseDay'/>"
    		},
    		{
    			name: "amountFirstMon",
    			title: "<spring:message code='dailyReport.amountFirstMon'/>"
    		},
    		{
    			name: "amountImportMon",
    			title: "<spring:message code='dailyReport.amountImportMon'/>"
    		},
    		{
    			name: "amountExportMon",
    			title: "<spring:message code='dailyReport.amountExportMon'/>"
    		},
    		{
    			name: "amountReviseMon",
    			title: "<spring:message code='dailyReport.amountReviseMon'/>"
    		},
    		{
    			name: "amountFirstSal",
    			title: "<spring:message code='dailyReport.amountFirstSal'/>"
    		},
    		{
    			name: "amountImportSal",
    			title: "<spring:message code='dailyReport.amountImportSal'/>"
    		},
    		{
    			name: "amountExportSal",
    			title: "<spring:message code='dailyReport.amountExportSal'/>"
    		},
    		{
    			name: "amountReviseSal",
    			title: "<spring:message code='dailyReport.amountReviseSal'/>"
    		},
    		{
    			name: "reviseSal",
    			title: "<spring:message code='dailyReport.reviseSalPct'/>"
    		}
    	],
    ...
    var DynamicForm_DailyReport = isc.DynamicForm.create({
        ...
        fields:
            [
                {
                    name: "toDay", ID: "toDayDate", title: "<spring:message code='dailyWarehouse.toDay'/>",
		 type: 'text', align: "center", width: 150, colSpan: 1, titleColSpan: 1
                    , icons: [{
