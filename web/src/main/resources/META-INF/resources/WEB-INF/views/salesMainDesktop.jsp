...
<script type="application/javascript">
    ...
    if (mylocale === "fa")
        var FilterBuilderOperator = {
            ...
            between: 'بین (دقیق)',
            betweenInclusive: 'بین (شامل, دقیق)',
            iBetween: 'بین',
            iBetweenInclusive: 'بین (شامل)',
            contains: 'شامل (دقیق)',
            iContains: 'شامل',
            startsWith: 'شروع می شود با (دقیق)',
            iStartsWith: 'شروع می شود با',
            endsWith: 'به پایان می رسد با (دقیق)',
            iEndsWith: 'به پایان می رسد با',
            notContains: 'شامل نیست (دقیق)',
            iNotContains: 'شامل نیست',
            notStartsWith: 'شروع نمی شود با (دقیق)',
            iNotStartsWith: 'شروع نمی شود با',
            notEndsWith: 'به پایان نمی رسد با (دقیق)',
            iNotEndsWith: 'به پایان نمی رسد با',
            isBlank: 'خالی است',
            notBlank: 'خالی نیست',
            isNull: 'بدون مقدار است',
            notNull: 'بدون مقدار نیست',
            regexp: 'همخوانی عبارت( دقیق)',
            iregexp: 'همخوانی عبارت',
            matchesPattern: 'مطابق الگو(دقیق)',
            iMatchesPattern: ' مطابق الگو',
            inSet: 'هست یکی از',
            notInSet: 'نیست یکی از',
            equalsField: 'مساوی فیلد (دقیق)',
            iEqualsField: 'مطابق فیلد',
            notEqualField: 'نامساوی با فیلد (دقیق)',
            iNotEqualField: 'متفاوت از فیلد',
            greaterThanField: 'بزرگتر از فیلد',
            lessThanField: 'کمتر از فیلد',
            greaterOrEqualField: 'بزرگتر یا مساوی فیلد',
            lessOrEqualField: 'کمتر یا مساوی فیلد',
            containsField: 'حاوی مقدار فیلد (دقیق)',
            iContainsField: 'حاوی مقدار فیلد ',
            startsWithField: 'شروع با مقدار فیلد (دقیق)',
            iStartsWithField: 'شروع با مقدار فیلد',
            endsWithField: 'پایان با مقدار فیلد(دقیق)',
            iEndsWithField: 'پایان با مقدار فیلد',
            notContainsField: 'شامل مقدار فیلد نمی شود(دقیق)',
            iNotContainsField: 'شامل مقدار فیلد نمی شود',
            notStartsWithField: 'با مقدار فیلد شروع نمی شود(دقیق)',
            iNotStartsWithField: 'با مقدار فیلد شروع نمی شود',
            notEndsWithField: 'با مقدار فیلد به پایان نمی رسد(دقیق)',
            iNotEndsWithField: 'با مقدار فیلد به پایان نمی رسد',
            and: 'مطابقت با همه',
            not: 'عدم مطابقت',
            or: 'مطابق با هرکدام',
            containsPattern: 'شامل الگو(دقیق)',
            iContainsPattern: 'شامل الگو',
            startsWithPattern: 'شروع شود با الگو(دقیق)',
            iStartsWithPattern: 'شروع شود با الگو',
            endsWithPattern: 'پایان با الگو (دقیق)',
            iEndsWithPattern: 'پایان با الگو',
        };
    else
        var FilterBuilderOperator = {
