...
var IButton_Material_Save = isc.IButtonSave.create({
    ...
    click: function () {
        ...
        if (DynamicForm_Material.hasErrors()) return;
    ...
    fields: [
        ...
        },
        {
            ...
            optionDataSource: isc.MyRestDataSource.create({
                fields: BaseFormItems.concat([{ name: "id" }, { name: "nameFA" }, { name: "nameEN" }, { name: "categoryValue", title: "categoryValue" }]),
...
var ListGrid_Material = isc.ListGrid.create({
    ...
    getExpansionComponent: function (record) {
        ...
        var hLayout = isc.HLayout.create({
            ...
            padding: 5,
            membersMargin: 20,
            members: [ToolStripButton_MaterialItem_Add],
        });
...
var IButton_MaterialItem_Save = isc.IButtonSave.create({
    ...
    click: function () {
        ...
        if (DynamicForm_MaterialItem.hasErrors()) return;
...
var Window_MaterialItem = isc.Window.create({
    ...
    items: [DynamicForm_MaterialItem, HLayout_MaterialItem_IButton],
});
