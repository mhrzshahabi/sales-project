isc.loadSkin = function (theWindow) {
    ...
    with (theWindow) {
        ...
        isc.Canvas.registerFontScaledPaddingStyles(["tabButtonTop", "tabButtonBottom"], ["iconOnlyTabButtonTop", "iconOnlyTabButtonBottom"], 3);
        var useCSS3 = isc.Browser.useCSS3, useSpriting = isc.Browser.useSpriting;
        if (!useCSS3 || !useSpriting) {
            isc.logWarn("Tahoe skin makes use of HTML5 features which may be unsupported in this browser. The appearance of components cannot be guaranteed. See the 'Skinning' documentation topic for more information.")
        }
