isc.loadSkin = function (theWindow) {
    ...
    with (theWindow) {
        ...
        isc.Canvas.registerIconSizingAttributes("fonts", {
            ComboBoxItem: [["pickerIconHeight", "pickerIconWidth"], ["pickButtonHeight", "pickButtonWidth"]],
            SelectItem: [["pickerIconHeight", "pickerIconWidth"], ["pickButtonHeight", "pickButtonWidth"]],
            CheckboxItem: [["valueIconHeight", "valueIconWidth"]],
            TreeGrid: ["openerIconSize"],
            ListGrid: [["checkboxFieldImageHeight", "checkboxFieldImageWidth"], ["booleanImageHeight", "booleanImageWidth"], "removeIconSize"],
            ToolStripButton: ["height", "iconSize"],
            ToolStrip: ["height"],
            MenuButton: [["iconHeight", "iconWidth"], "iconSize"],
            TabSet: ["defaultTabIconSize"],
            SpinnerItem: [["stackedIconsHeight", "stackedIconsWidth"]]
        });
        isc.Canvas.registerIconSizingAttributes("controls", {
            DateItem: [["pickerIconHeight", "pickerIconWidth"]],
            DatetimeItem: [["pickerIconHeight", "pickerIconWidth"]],
            RelativeDateItem: [["pickerIconHeight", "pickerIconWidth"]],
            MiniDateRangeItem: [["pickerIconHeight", "pickerIconWidth"]],
            ColorItem: [["pickerIconHeight", "pickerIconWidth"]],
            ListGrid: ["defaultEditableDateFieldWidth", "defaultEditableDateTimeFieldWidth"]
        });
        isc.Canvas.setAutoResizeIcons(true);
        isc.Canvas.registerAutoChildSizingAttributes("fonts", "Window", {
        ...
        isc.Canvas.registerFontScaledPaddingStyles(["tabButtonTop", "tabButtonBottom"], ["iconOnlyTabButtonTop", "iconOnlyTabButtonBottom"], 0);
        var useCSS3 = isc.Browser.useCSS3, useSpriting = isc.Browser.useSpriting;
        if (!useCSS3 || !useSpriting) {
            isc.logWarn("Nicico skin makes use of HTML5 features which may be unsupported in this browser. The appearance of components cannot be guaranteed. See the 'Skinning' documentation topic for more information.")
        }
        isc.Canvas.setProperties({groupBorderCSS: "1px solid #165fa7", showCustomScrollbars: true});
        isc.Canvas.addProperties({scrollbarSize: 16});
        ...
        if (isc.SpritedScrollbar) {
            ...
            isc.SpritedVSimpleScrollThumb.addProperties({imageStyle: "vScrollThumbGrip"});
            isc.SpritedHSimpleScrollThumb.addProperties({imageStyle: "hScrollThumbGrip"});
            ...
            isc.SpritedScrollbar.changeDefaults("startImg", {
                name: "blank1",
                baseStyleKey: "vertical",
                baseStyleMap: {"true": "vScrollStart", "false": "hScrollStart"},
                baseStyle: "scrollStart"
            });
            isc.SpritedScrollbar.changeDefaults("endImg", {
                name: "blank10",
                baseStyleKey: "vertical",
                baseStyleMap: {"true": "vScrollEnd", "false": "hScrollEnd"},
                baseStyle: "scrollEnd"
            })
        }
        ...
        isc.ClassFactory.defineClass("IAutoFitButton", "AutoFitButton").addProperties({baseStyle: "button"});
        ...
        isc.ClassFactory.defineClass("HeaderMenuButton", "IButton").addProperties({baseStyle: "headerButton"});
        if (isc.MenuButton) {
        ...
        isc.Label.addProperties({showFocused: false, showFocusOutline: true});
        isc.Layout.addProperties({resizeBarSize: 7, resizeBarClass: "Snapbar"});
        isc.StretchImgSplitbar.addProperties({capSize: 10, showGrip: true, showOver: false});
        ...
        if (isc.MultiGroupDialog) {
            isc.MultiGroupDialog.addProperties({height: 295, showShadow: true, shadowColor: "#f0f0f0", shadowDepth: 10})
        }
        if (isc.MultiSortDialog) {
            isc.MultiSortDialog.addProperties({height: 295, showShadow: true, shadowColor: "#f0f0f0", shadowDepth: 10})
        }
        ...
        if (isc.TabBar) {
            isc.TabBar.changeDefaults("baseLineDefaults", {_constructor: "Canvas", backgroundColor: "#9C9C9C"});
            isc.TabBar.changeDefaults("tabDefaults", {showFocusOutline: false})
        }
        if (isc.TabSet) {
            ...
            isc.TabSet.changeDefaults("scrollerDefaults", {renderStretchImgInTable: false, backgroundColor: "#e6e6e6"});
        ...
        if (isc.ImgTab) {
            isc.ImgTab.addProperties({capSize: 6, showFocusedAsOver: true})
        }
        if (isc.SimpleTabButton) {
            isc.SimpleTabButton.addProperties({showFocusedAsOver: false})
        }
        if (isc.Window) {
            ...
            isc.Window.changeDefaults("headerProperties", {layoutMargin: 4});
            isc.Window.changeDefaults("headerDefaults", {height: 30, cursor: "inherit"});
            ...
            isc.Window.changeDefaults("headerDefaults", {layoutMargin: 0, layoutRightMargin: 4});
            if (isc.Dialog) {
                isc.Dialog.addProperties({layoutMargin: 0})
            }
            if (isc.ColorItem) {
                isc.ColorItem.addProperties({showEmptyPickerIcon: true, pickerIconHeight: 22, pickerIconWidth: 22});
                isc.ColorItem.changeDefaults("pickerIconDefaults", {showRTL: true, showFocused: false, showOver: false})
            }
            if (isc.MultiFilePicker) {
                isc.MultiFilePicker.addProperties({showInWindow: true})
            }
            if (isc.ColorPicker) {
                ...
                isc.ColorPicker.changeDefaults("headerLabelDefaults", {styleName: "colorPickerHeaderText"});
                ...
                isc.ColorPicker.changeDefaults("closeButtonDefaults", {src: "[SKIN]ColorPicker/close_button.png"});
                ...
                isc.ColorPicker.changeDefaults("contentLayoutDefaults", {layoutMargin: 10, membersMargin: 8});
            ...
            if (isc.HiliteRule) {
                ...
                isc.HiliteRule.changeDefaults("clauseDefaults", {layoutAlign: "bottom", width: 400})
            }
            if (isc.AdvancedHiliteEditor) {
                ...
                isc.AdvancedHiliteEditor.changeDefaults("filterBuilderDefaults", {fieldPickerWidth: 150})
            }
            if (isc.Canvas) {
                isc.Canvas.changeDefaults("hiliteWindowDefaults", {width: 850})
            }
        }
        if (isc.Dialog) {
            ...
            isc.Dialog.changeDefaults("toolbarDefaults", {buttonConstructor: "IButton", height: 42, membersMargin: 10});
            ...
            if (isc.Dialog.Warn) {
                if (isc.Browser.isTouch) {
                    isc.Dialog.Warn.showModalMask = true
                }
            }
            if (isc.Dialog.Prompt) {
                if (isc.Browser.isTouch) {
                    isc.Dialog.Prompt.showModalMask = true
                }
            }
        }
        if (isc.Menu) {
            isc.Menu.addProperties({styleName: "menuBorder", iconFillSpaceStyleName: "menuFill"})
        }
        if (isc.Menu) {
            ...
            isc.Menu.changeDefaults("iconFieldDefaults", {baseStyle: "menuIconField", width: 24});
            isc.Menu.changeDefaults("titleFieldDefaults", {baseStyle: "menuTitleField"})
        }
        if (isc.ListGrid) {
            isc.ListGrid.addProperties({expansionFieldImageShowRTL: true});
        ...
        if (isc.ListGrid) {
            ...
            isc.ListGrid.changeDefaults("defaultFieldWidthScaleFactors", {EditableDate: 5, EditableDateTime: 7});
            ...
            isc.ListGrid.changeDefaults("sorterDefaults", {baseStyle: "sorterButton", showRollOver: false});
            isc.ListGrid.changeDefaults("headerMenuButtonDefaults", {showFocusedAsOver: true});
            isc.ListGrid.changeDefaults("headerButtonDefaults", {showFocusedAsOver: true});
            isc.ListGrid.changeDefaults("headerSpanDefaults", {baseStyle: "headerSpanButton"})
        }
        if (isc.GridRenderer) {
        ...
        if (isc.RecordEditor) {
            isc.RecordEditor.changeDefaults("actionButtonDefaults", {border: "1px solid #b8b8b8"});
        ...
        if (isc.ComboBoxItem) {
            isc.ComboBoxItem.addProperties({pickListTallBaseStyle: "tallPickListCell"});
            isc.ComboBoxItem.changeDefaults("pickerIconDefaults", {showOver: false, showRTL: false});
            isc.ComboBoxItem.changeDefaults("separateValuesListDefaults", {showOverAsSelected: false});
            ...
            if (!isc.Browser.isIE || isc.Browser.isIE11) {
                isc.ComboBoxItem.changeDefaults("pickerSearchFormDefaults", {height: 30});
        ...
        if (isc.MultiComboBoxItem) {
            isc.MultiComboBoxItem.addProperties({
                ...
                valueLayoutProperties: {membersMargin: 1, tileMargin: 1}
            });
        ...
        if (isc.PickTreeItem) {
            isc.PickTreeItem.addProperties({pendingButtonStyle: "menuButtonPending"});
            isc.PickTreeItem.changeDefaults("buttonDefaults", {height: 21})
        }
        if (isc.SelectItem) {
            isc.SelectItem.addProperties({pickListTallBaseStyle: "tallPickListCell"});
            isc.SelectItem.changeDefaults("pickerIconDefaults", {showOver: true, showRTL: true});
            isc.SelectItem.changeDefaults("separateValuesListDefaults", {showOverAsSelected: false});
        ...
        if (isc.RichTextEditor) {
            ...
            isc.RichTextEditor.changeDefaults("toolbarDefaults", {layoutMargin: 6, membersMargin: 6});
            ...
            isc.RichTextEditor.changeDefaults("editAreaDefaults", {padding: 10})
        }
        ...
        if (isc.TextItem) {
            isc.TextItem.addProperties({height: 22, showFocused: true, textBoxStyle: "textItemLite"});
            isc.TextItem.addProperties({width: 220})
        }
        if (isc.TextAreaItem) {
            isc.TextAreaItem.addProperties({showFocused: true, textBoxStyle: "textAreaItemLite", pickerIconHeight: 18});
            isc.TextAreaItem.addProperties({width: 220})
        }
        if (isc.SelectItem) {
            isc.SelectItem.addProperties({
                showOver: true,
            ...
            isc.SelectItem.addProperties({width: 220});
            if (isc.NativeSelectItem) {
                isc.NativeSelectItem.addProperties({width: 220})
            }
        }
        if (isc.ComboBoxItem) {
            isc.ComboBoxItem.addProperties({
        ...
        if (isc.ScrollingMenu) {
            isc.ScrollingMenu.addProperties({shadowDepth: 5, showShadow: false, showSelectedRollOverCanvas: false})
        }
        if (isc.PickListMenu) {
        ...
        if (isc.ScrollingTreeMenu) {
            isc.ScrollingTreeMenu.addProperties({shadowDepth: 5, showShadow: false, showSelectedRollOverCanvas: false})
        }
        if (isc.PickTreeMenu) {
        ...
        if (isc.PickList) {
            isc.PickList.addInterfaceProperties({pickListCellHeight: 17});
            if (isc.SelectItem) {
                isc.SelectItem.addProperties({pickListCellHeight: 17})
            }
            if (isc.ComboBoxItem) {
                isc.ComboBoxItem.addProperties({pickListCellHeight: 17})
            }
        }
        if (isc.DateItem) {
            ...
            isc.DateItem.addProperties({textBoxStyle: "textItemLite"});
            if (isc.NativeDateItem) {
                isc.NativeDateItem.addProperties({textBoxStyle: "textItemLite"})
            }
            if (isc.NativeTimeItem) {
                isc.NativeTimeItem.addProperties({textBoxStyle: "textItemLite"})
            }
        ...
        if (isc.SliderItem) {
            isc.SliderItem.addProperties({width: 220})
        }
        ...
        if (isc.DateChooser) {
            ...
            isc.DateChooser.changeDefaults("weekChooserButtonDefaults", {
                height: 45,
                minWidth: 30,
                width: 30,
                align: "right",
            ...
            isc.DateChooser.changeDefaults("fiscalYearChooserButtonDefaults", {
                height: 45,
                minWidth: 45,
                width: 45,
                align: "right",
            ...
            isc.DateChooser.changeDefaults("previousYearButtonDefaults", {
                height: 45,
                width: 30,
                align: "right",
                showFocusedAsOver: true
            });
            isc.DateChooser.changeDefaults("previousMonthButtonDefaults", {
                height: 45,
                width: 30,
                align: "left",
                showFocusedAsOver: true
            ...
            isc.DateChooser.changeDefaults("nextMonthButtonDefaults", {
                height: 45,
                width: 30,
                align: "right",
                showFocusedAsOver: true
            });
            isc.DateChooser.changeDefaults("nextYearButtonDefaults", {
                height: 45,
                width: 30,
                align: "left",
                showFocusedAsOver: true
        ...
        if (isc.ToolStrip) {
            ...
            if (isc.RibbonBar) {
                isc.RibbonBar.addProperties({styleName: "ribbonBar", layoutMargin: 8, membersMargin: 10})
            }
        }
        if (isc.ToolStripGroup) {
            ...
            if (isc.RibbonGroup) {
                isc.RibbonGroup.addProperties({styleName: "ribbonGroup"})
            }
        }
        if (isc.ToolStripMenuButton) {
            isc.overwriteClass("ToolStripMenuButton", "MenuButton").addProperties({
                ...
                iconWidth: 8,
                iconHeight: 6,
                menuButtonImage: "[SKIN]nicico_menuButton_down.png",
                menuButtonImageUp: "[SKIN]nicico_menuButton_down.png",
                showDown: true,
                showRollOver: true,
                showTitle: false
            })
        ...
        isc.ListGrid.changeDefaults("refreshButtonDefaults", {
            styleName: "operation-toolstrip-remove",
        });
        if (isc.EdgedCanvas) {
            isc.EdgedCanvas.addProperties({edgeSize: 3, edgeImage: "[SKINIMG]edges/edge.png"})
        }
        if (isc.Slider) {
            isc.Slider.changeDefaults("rangeLabelDefaults", {showDisabled: true});
            isc.Slider.changeDefaults("valueLabelDefaults", {showDisabled: true})
        }
        if (isc.Slider) {
        ...
        if (isc.TileGrid) {
            isc.TileGrid.addProperties({showEdges: false, styleName: null, valuesShowRollOver: true})
        }
        if (isc.RichTextEditor) {
        ...
        if (isc.Calendar) {
            ...
            isc.Calendar.changeDefaults("controlsBarDefaults", {height: 10, layoutBottomMargin: 10});
            isc.EventWindow.changeDefaults("resizerDefaults", {src: "[SKIN]/Window/v_resizer.png"});
            isc.TimelineWindow.changeDefaults("resizerDefaults", {src: "[SKIN]/Window/h_resizer.png"})
        }
        if (isc.CubeGrid) {
            isc.CubeGrid.addProperties({alternateFieldStyles: false, arrowIconSize: 14});
            isc.CubeGrid.changeDefaults("rollOverCanvasDefaults", {styleName: "cubeSelectionOver"})
        }
        if (isc.PrintWindow) {
            isc.PrintWindow.changeDefaults("printButtonDefaults", {height: 27})
        }
        if (isc.SplitPanePagedPanel) {
            isc.SplitPanePagedPanel.addProperties({skinUsesCSSTransitions: true})
        }
        if (isc.SplitPaneSidePanel) {
            isc.SplitPaneSidePanel.addProperties({skinUsesCSSTransitions: true})
        }
        if (isc.SplitPane) {
            isc.SplitPane.addProperties({desktopNavigationBarHeight: 35});
            ...
            if (isc.Browser.isIPhone || isc.Browser.isIPad) {
                isc.SplitPane.changeDefaults("backButtonDefaults", {icon: "[SKINIMG]NavigationBar/back_arrow.svg"})
            }
            isc.SplitPane.changeDefaults("detailTitleLabelDefaults", {baseStyle: "detailPaneTitle"});
            isc.SplitPane.changeDefaults("listTitleLabelDefaults", {baseStyle: "listPaneTitle"});
            isc.SplitPane.changeDefaults("navigationBarDefaults", {navBarHeaderStyleName: "navBarHeaderPaneTitle"})
        }
        if (isc.Gauge) {
            isc.Gauge.addProperties({fontSize: 11, needleColor: "#4e4e4e"});
        ...
        if (isc.FacetChart) {
            isc.FacetChart.addProperties({
                padding: 0,
                titleProperties: {fontFamily: "Arial", fontSize: 12, fontWeight: "bold", fontColor: "#616161"},
                titleBackgroundProperties: {lineWidth: 0, lineOpacity: 0, lineColor: "#cccccc", fillColor: "#f0f0f0"},
                titleAlign: "left",
                titlePadding: 10,
                drawTitleBackground: true,
                drawTitleBoundary: true,
                titleBoundaryProperties: {lineColor: "#cccccc", lineWidth: 1},
                titleRectHeight: 32,
                legendAlign: "right",
                drawLegendBoundary: true,
                legendBoundaryProperties: {lineColor: "#cccccc", lineWidth: 1},
                legendRectProperties: {lineWidth: 1, lineOpacity: 0, lineColor: "#cccccc"},
                legendPadding: 12,
                legendSwatchProperties: {lineWidth: 0, lineColor: "#FFFFFF"},
                showLegendRect: true,
                gradationLabelPadding: 10,
                chartRectMargin: 15,
                backgroundBandProperties: {excludeFromQuadTree: true, lineOpacity: 0, fillColor: "#f7f7f7"},
                gradationLineProperties: {excludeFromQuadTree: true, lineWidth: 1, lineColor: "#e4e4e4"},
                showShadows: false,
                useAutoGradients: false,
                barProperties: {lineColor: null, lineWidth: 1},
                yAxisLabelPadding: 3,
        ...
        if (isc.FilterBuilder) {
            isc.FilterBuilder.addProperties({fieldPickerWidth: 120, operatorPickerWidth: 180});
            isc.FilterBuilder.changeDefaults("topOperatorFormDefaults", {width: 130})
        }
        if (isc.SectionStack) {
            isc.SectionStack.addProperties({headerHeight: 39})
        }
        ...
        if (isc.NavigationBar) {
            ...
            isc.NavigationBar.changeDefaults("titleLabelDefaults", {margin: 0});
            if (isc.Browser.isIPhone || isc.Browser.isIPad) {
                isc.NavigationBar.addProperties({leftButtonIcon: "[SKINIMG]NavigationBar/back_arrow.svg"})
            }
        }
        ...
        if (isc.Hover) {
            isc.addProperties(isc.Hover.hoverCanvasDefaults, {shadowDepth: 5, showShadow: false})
        }
        isc.pickerImgType = "png";
        isc.transferImgType = "png";
        isc.headerImgType = "png";

        if (isc.setCurrentSkin) {
            isc.setCurrentSkin("Nicico", "Flat")
        }
        if (isc.ExampleViewer) {
            isc.ExampleViewer.installSkinCustomizations = function () {
                ...
                isc.VersionLabel.addProperties({styleName: "versionLabel" + skin});
                isc.TitlePagePane.addProperties({layoutMargin: 0});
                ...
                isc.TitlePagePane.changeDefaults("folderListDefaults", {styleName: "explorerFolderList" + skin});
                isc.ExampleViewer.changeDefaults("optionsMenuButtonDefaults", {width: 50});
                isc.ExampleViewer.changeDefaults("skinSwitcherDefaults", {margin: 3});
                isc.ExampleViewer.changeDefaults("densitySwitcherDefaults", {margin: 3});
                isc.ExampleViewer.changeDefaults("screenshotDefaults", {showEdges: false, border: "1px solid #ccc"});
                isc.ExampleViewerSectionHeader.addProperties({baseStyle: "centerPane" + skin + "Header"});
                ...
                if (isc.Browser.isDesktop) {
                    isc.HomeInterface.changeDefaults("customTileGridDefaults", {styleName: "showcaseTileGrid" + skin})
                }
                ...
                isc.HomeInterface.changeDefaults("tileDefaults", {baseStyle: "showcaseTile" + skin});
                isc.ExplorerCheckboxItem.addProperties({textBoxStyle: "sampleTypeLabelAnchor" + skin});
                isc.CustomTile.addProperties({thumbnailFieldAddedHeight: 18});
                ...
                isc.GridSearch.addProperties({
                    ...
                    height: isc.SectionStack.getPrototype().headerHeight,
                    searchItemProperties: {height: isc.TextItem.getPrototype().getHeight()}
                });
                isc.WebRightButtonBox.addProperties({showGradient: false, styleName: "explorerButtonBoxR" + skin});
                isc.WebRightButton.addProperties({
                    fontSize: 10, lineHeight: 14, getSkinStyle: function (style) {
                ...
                isc.FeatureExplorer.changeDefaults("learnMoreButtonRDefaults", {height: 84});
        ...
        if (cssLoaded != null) {
            isc.FontLoader.loadCustomFonts(["corbel", "corbel-bold", "calibri", "RobotoLight"], cssLoaded)
        }
