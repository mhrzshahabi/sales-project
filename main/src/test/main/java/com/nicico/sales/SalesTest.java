...
import com.nicico.sales.service.MaterialItemService;
...
//    }
    ...
    @Test
    @Transactional
    public void tozinDaoTest() {
        List<TozinLite> all = tozinLiteDAO.findAll();
        System.out.printf("a");
    }

    @Test
    @Transactional
    public void updateMaterialUpdate() {
